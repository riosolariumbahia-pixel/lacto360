...
function CadastroPage() {
  ...
  function submit(e: React.FormEvent) {
    e.preventDefault();
    sessionApi.signUp(name, email, laticinio);
      ...
      <div className="flex items-center justify-center p-6 order-2 md:order-1">
        <form onSubmit={submit} className="w-full max-w-sm space-y-5">
          <div>
            ...
            <p className="mt-1 text-sm text-muted-foreground">7 dias de Pro — sem cartão.</p>
          </div>
          ...
          <Button type="submit" className="w-full bg-gradient-primary">Criar conta grátis</Button>
